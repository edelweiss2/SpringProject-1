				...
				<div class="container-fluid bg-gray-200 w-full min-h-screen flex items-center justify-center overflow-hidden">
					<div class="lg:flex items-center space-x-16">
						<div class="xl:w-[500px] 2xl:w-[550px] mx-auto px-16 py-8 rounded-lg">
							<h1 class="text-center text-3xl font-bold tracking-wide text-gray-800">Sign Up</h1>
							<p class="text-center text-sm text-gray-600 mt-2">
								Already have an account?
								<a href="/user/login" class="text-blue-600 hover:text-blue-700 hover:underline" title="Sign In">Sign
									in here</a>
							</p>

							<!-- 입력창 -->
							<form action="/user/register" method="post" class="my-8 text-sm">
								<!-- 아이디 -->
